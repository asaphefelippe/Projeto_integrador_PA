...
if (isset($_POST['enviar'])) {
    ...
    if ($sql->execute()) {
        ...
        foreach ($info as $key => $values) {
            echo 'acumulos do cliente : <strong>' . $values['acumulo']  . '</strong><br>';
            $nom = $values['nome'];
            $cod = $values['codigo'];
        }
    }
    ...
    if ($comida1 > 100) {
        ...
        foreach ($info as $key => $values1) {
            echo 'Combo numero : ' . $values1['numero_comb'] . ',o cliente vai ganha ' . $values1['acumulos'] . ' pontos por este combo <br>';
    ...
    if ($comida2 > 100) {
        ...
        foreach ($info as $key => $values2) {
            echo 'Combo numero : ' . $values2['numero_comb'] . ',o client vai ganha ' . $values2['acumulos'] . ' pontos por este combo <br>';
            echo '<strong>Nele sera incluindo : </strong><br>';
    ...
    if ($comida3 > 100) {
        ...
        foreach ($info as $key => $values3) {
            echo 'Combo numero : ' . $values3['numero_comb'] . ',o client vai ganha ' . $values3['acumulos'] . ' pontos por este combo <br>';
            echo '<strong>Nele sera incluindo : </strong><br>';
        ...
        $info = $sql->fetchAll();
        foreach ($info as $key => $values3) {
            echo 'client vai ganhar ' . $values3['acumulos'] . ',o pontos por esta comida<br>';
    ...
    if ($comida4 > 100) {
        ...
        foreach ($info as $key => $values4) {
            echo 'Combo numero : ' . $values4['numero_comb'] . ',o client vai ganha ' . $values4['acumulos'] . ' pontos por este combo <br>';
            echo '<strong>Nele sera incluindo : </strong><br>';
    ...
    if ($comida5 > 100) {
        ...
        foreach ($info as $key => $values5) {
            echo 'Combo numero : ' . $values5['numero_comb'] . ',o client vai ganhar ' . $values5['acumulos'] . ' pontos por este combo <br>';
            echo '<strong>Nele sera incluindo : </strong><br>';
    ...
    if ($sql->execute(array($soma, $codigo))) {
        ...
        echo '<strong  style="color:green">Dados cadastrados com sucesso</strong>';
        header("Refresh:5");
    } else {
        echo '<strong style=color:"red">Dados não cadastrado</strong>';
    }
}
